    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark text-light" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
                ...
                <a href="{{ url('/') }}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">back</div>
        ...
        <form action="{{ route('organisme.store') }}"   method="POST" style="margin:10px;">
            @csrf
            @method('post')
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <div class="mb-3"><label class="form-label"><strong>Nom Organisme </strong></label><input class="form-control" type="text" placeholder="Nom d'organisme" name="Nom" required=""></div>
                        </div>
                        <div class="col-sm-12 col-md-4 col-lg-4">
                            <div class="mb-3"><label class="form-label" for="service_price"><strong>Numero de Telephone</strong><br></label><input class="form-control" type="text"  placeholder="Entrez le numero de telephone" name="Numero_de_telephone" required=""></div>
                        </div>
                    </div>
                    <div class="mb-3"><label class="form-label" ><strong>Adresse </strong><br></label><textarea class="form-control"  rows="4" name="Adresse" placeholder="Entrez l'Adresse" required=""></textarea></div>
                    <div class="mb-3"><label class="form-label" ><strong>Nom de Contact </strong></label><input class="form-control" type="text"  placeholder="Entrez le nom de contact" name="Le_nom_de_contact" required=""></div>
                    <div class="mb-3"><label class="form-label"  ><strong>Email de Contact </strong></label><input class="form-control" type="text"  placeholder="Entrez l'email de contact" name="Email_de_contact" required=""></div>
                    <div class="mb-3"><label class="form-label"  ><strong>Adresse Web</strong></label><input class="form-control" type="text"  placeholder="Entrez l'adresse web" name="Adresse_web" required=""></div>
